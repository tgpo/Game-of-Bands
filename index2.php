    ...
    <header>
        <section id="bestOf">
            ...
            <ul>
                ...
                <li>Best Musician</li>
                <li>Best Vocalist</li>
                <li>Best Save (Someone who replaced a quitter on a team)</li>
                <li>Song/Bandit Who Should Have Won, but didn't</li>
                <li>Criminally under-appreciated song</li>
                <li>Criminally under-appreciated bandit</li>
                <li>Best application of a round's theme</li>
            </ul>
        </section>
